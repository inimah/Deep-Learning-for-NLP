...
if __name__ == '__main__':
	...
	doc_vector = readPickle(os.path.join(EMBEDDINGS,'avgIDF_embed1'))
	...
	savePickle(trainDat, os.path.join(RESULTS,'w2v_avgIDF_trainDat'))
	savePickle(testDat, os.path.join(RESULTS,'w2v_avgIDF_testDat'))
	...
	savePickle(history_train.losses, os.path.join(RESULTS,'eval_mlp_w2v_avgIDF.losses'))
	savePickle(history_train.acc,os.path.join(RESULTS,'eval_mlp_w2v_avgIDF.acc'))
